...
/*document.write("Bievenido: " + nombre   + " " + apellido  + "<br>" + "Su direccion es: " + direccion  + "<br>" + "Su numero es: " + numero  + "<br>" + "El modelo del celular a comprar es: Samsung Galaxy A32" + "<br>" + "Usted selecciono el metodo de pago: " + selected + "<br>" + "El precio final a pagar es: U$S " + descuento);
*/
...
/*document.write("Bievenido: " + nombre   + " " + apellido  + "<br>" + "Su direccion es: " + direccion  + "<br>" + "Su numero es: " + numero  + "<br>" + "El modelo del celular a comprar es: XIAOMI Redmi 9C" + "<br>" + "Usted selecciono el metodo de pago: " + selected + "<br>" + "El precio final a pagar es: U$S " + descuento);
*/
}
...
/*document.write("Bievenido: " + nombre   + " " + apellido  + "<br>" + "Su direccion es: " + direccion  + "<br>" + "Su numero es: " + numero  + "<br>" + "El modelo del celular a comprar es: HUAWEI Y8P 2020" + "<br>" + "Usted selecciono el metodo de pago: " + selected + "<br>" + "El precio final a pagar es: U$S " + descuento);*/
