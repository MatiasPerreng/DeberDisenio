...
document.write(`<!DOCTYPE html> <html lang="en"> <head> <meta charset="UTF-8"> <meta http-equiv="X-UA-Compatible" content="IE=edge"> <meta name="viewport" content="width=device-width, initial-scale=1.0"> <link rel="stylesheet" href="css/bootstrap.min.css"> <title>Document</title> </head> <body> <div class="container"><div class="row"> <table class="table table-bordered"> <thead> <tr> <th scope="col">Datos</th> <th scope="col">Nombre</th> <th scope="col">Apellido</th> <th scope="col">Dirección</th> <th scope="col">Número</th> <th scope="col">Modelo Celular</th> <th scope="col">Método de pago</th> <th scope="col">Precio final</th> </tr> </thead> <tbody> <tr> <th scope="row">Cliente 1</th> <td>${nombre}</td> <td>${apellido}</td> <td>${direccion}</td> <td>${numero}</td> <td>XIAOMI Redmi 9C</td> <td>${selected}</td> <td>${descuento}</td> </tr> </tbody> </table></div><div class="row"> <div class="col-12 d-flex justify-content-center"> <button class="btn btn-dark" style="outline: none;box-shadow: none; border-radius:17px;"><a href="index.php" style="text-decoration:none; list-style:none; color:rgb(250, 250, 250);">Volver</a></button> </div></div></body> </html>`);
...
document.write(`<!DOCTYPE html> <html lang="en"> <head> <meta charset="UTF-8"> <meta http-equiv="X-UA-Compatible" content="IE=edge"> <meta name="viewport" content="width=device-width, initial-scale=1.0"> <link rel="stylesheet" href="css/bootstrap.min.css"> <title>Document</title> </head> <body> <div class="container"><div class="row"> <table class="table table-bordered"> <thead> <tr> <th scope="col">Datos</th> <th scope="col">Nombre</th> <th scope="col">Apellido</th> <th scope="col">Dirección</th> <th scope="col">Número</th> <th scope="col">Modelo Celular</th> <th scope="col">Método de pago</th> <th scope="col">Precio final</th> </tr> </thead> <tbody> <tr> <th scope="row">Cliente 1</th> <td>${nombre}</td> <td>${apellido}</td> <td>${direccion}</td> <td>${numero}</td> <td>HUAWEI Y8P 2020</td> <td>${selected}</td> <td>${descuento}</td> </tr> </tbody> </table></div><div class="row"> <div class="col-12 d-flex justify-content-center"> <button class="btn btn-dark" style="outline: none;box-shadow: none; border-radius:17px;"><a href="index.php" style="text-decoration:none; list-style:none; color:rgb(250, 250, 250);">Volver</a></button> </div></div></body> </html>`);
